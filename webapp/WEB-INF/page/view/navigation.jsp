...
<div class="middle">
			<div class="leftMenu">
				<div class="topMenu">
					<img class="banshi" src="http://www.jsdaima.com/Uploads/js/201705/1494562763/banshidating.png">
					<p class="menuTitle">词条管理系统</p>
					<img class="changeMenu" src="http://www.jsdaima.com/Uploads/js/201705/1494562763/shouqicaidan.png" onclick="hidMenu()">
				</div>
				<div class="menu_list">
					<ul>
						<li class="">
							<p class="fuMenu">系统设置</p>
							<img class="xiala" src="http://www.jsdaima.com/Uploads/js/201705/1494562763/xiala.png">
							<div class="div1">
